...
namespace EasyTextEffects
{
    public abstract class TextEffect_Base : ScriptableObject
    {
        ...
        // Reason: Set once per frame by TextEffect.Update() with the center of all visible characters.
        // Used as a shared pivot by whole-text effects (rotate/scale around this point).
        [System.NonSerialized] public Vector3 cachedTextCenter;
